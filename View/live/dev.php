	<title>Programmation | TV | Sedios</title>
...
<body>
	...
	<div class="container"><?php Controller::inMaintenance(); ?>
		<div id="title"><i class="fa fa-code"></i> Travaillons ensemble, en live !</div><br>
		...
		<div id="display">
		<?php if(LiveController::isOnAir("Dev")){ ?>
			<?php
				$_SESSION['tv'] = "Programmation";
			?>
			<div class="wrapper">
				<div id="live">
		          	<iframe frameborder="0" width="100%" height="100%" src="http://www.dailymotion.com/embed/video/x2fgoas?autoPlay=1" allowfullscreen></iframe>
		        </div>
			</div>
